package com.hanin.parfum.restcontrollers;
...
import com.hanin.parfum.service.ImageService;
import com.hanin.parfum.service.ParfumService;
...
public class ImageRestController {
	...
	@RequestMapping(value = "/loadfromFS/{id}" ,
			 method = RequestMethod.GET, produces = org.springframework.http.MediaType.IMAGE_JPEG_VALUE)
